...
/// Transforms a Cranelift [cranelift_codegen::ir::Signature] into the
/// corresponding [walrus::ValType]'s, returning them in the form
/// `(Vec<parameters>, Vec<return_values>)`.
